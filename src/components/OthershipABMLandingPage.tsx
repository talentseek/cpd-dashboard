        ...
        <section id="case-studies" className={styles.caseStudiesSection}>
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.caseStudiesGrid}>
              {caseStudyCompanies.map((company) => (
                <div key={company.name} className={styles.caseStudyCard}>
                  <div className={styles.cardHeader}>
                    <div className={styles.stat}>{company.stat}</div>
                    <div className={styles.logoWrapper}>
                      <Image
                        src={`/images/abm/othership/${company.file}`}
                  ...
                  <h3 className={styles.cardTitle}>{company.title}</h3>
                  <p className={styles.cardDescription}>
                    {company.description}
                  </p>
                </div>
