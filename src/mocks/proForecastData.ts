...
const proForecastData: LandingPageProps = {
  primaryColor: "#9ecc3b",
  ...
  socialSharingImage: "/images/proforecast/sharing-image.webp",
  logo: "/images/abm/proforecast/logo.svg",
  ctaButtonText: "Book my tour",
  ctaLink: "https://calendly.com/proforecastdemo/proforecast-demonstration-1", // Added CTA link

  hero: {
    heading: "Hi {first_name}, streamline {company}’s financial planning effortlessly.",
    ...
    ctaLink: "https://calendly.com/proforecastdemo/proforecast-demonstration-1", // Added CTA link in hero section
  },
  ...
  features: {
    ...
    items: [
      { heading: "Comprehensive Forecasting", subheading: "Integrate cash flow, balance sheet, and P&L forecasts tailored to {company}’s growth trajectory." },
      { heading: "‘What If’ Analysis", subheading: "Evaluate different scenarios to anticipate market changes and refine {company}’s strategy." },
      { heading: "Customizable Dashboards", subheading: "Design dashboards that track {company}’s financial health in real time." },
      { heading: "AI-Driven Insights", subheading: "Utilize machine learning to gain insights into demand forecasting and financial projections for {company}." },
      { heading: "Multi-User Collaboration", subheading: "Enable collaboration with role-based permissions for {company}’s finance team." },
      { heading: "Data Import/Export", subheading: "Import and export data from various accounting software seamlessly for {company}." },
      { heading: "Benchmarking Tools", subheading: "Compare {company}’s performance against industry standards for informed decision-making." },
      { heading: "Variance Reporting", subheading: "Identify deviations between actuals and forecasts to keep {company}’s strategy on track." },
      { heading: "KPI Tracking", subheading: "Monitor key performance indicators essential to {company}’s success." },
      { heading: "Cloud Accessibility", subheading: "Access ProForecast’s tools from anywhere, ensuring flexibility and convenience for {company}." },
    ],
  },
