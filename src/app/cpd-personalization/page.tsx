...
{cpdlanding}
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      {/* Page Title */}
      <h1 className="text-3xl font-bold mb-6">CostPerDemo Leads</h1>
          ...
          <div className="mb-6">
            <div className="bg-gray-100 p-4 rounded-lg shadow-inner">
              ...
              <ul className="mt-2 space-y-1 text-sm text-gray-600">
                <li>Total Leads: <span className="font-medium">{leads.length}</span></li>
                <li>With Company Data: <span className="text-green-600 font-medium">
                  {leads.filter((lead) => lead.company_data).length}
                </span></li>
                <li>Without Company Data: <span className="text-red-500 font-medium">
                  {leads.filter((lead) => !lead.company_data).length}
                </span></li>
              </ul>
            </div>
                ...
                leads.map((lead) => (
                  ...
                  >
                    <CardContent className="p-4">
                      ...
                      {/* Show company data presence */}
                      <div className="mt-2 text-xs text-gray-500">
                        {lead.company_data ? (
                          <span className="text-green-600 font-medium">✓ Company data available</span>
                        ) : (
                          <span className="text-red-500">✗ No company data</span>
                        )}
                      </div>
                    </CardContent>
                  </Card>
